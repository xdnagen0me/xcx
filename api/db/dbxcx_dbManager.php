...
function getConnection() {
	...
	global $db_xcx_db_Url, $db_xcx_db_User, $db_xcx_db_Pass, $db_xcx_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_xcx_db_Url.";dbname=".$db_xcx_db_DbName, $db_xcx_db_User, $db_xcx_db_Pass);
